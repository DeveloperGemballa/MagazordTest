...
@section('title','Edição cadastro pessoas')
@section('conteudo')
...
@endif
    <div class="container position-absolute top-50 start-50 translate-middle">
        {!! Form::open(['route' => ['pessoas.update',$pessoas->id], 'method' => 'PUT']) !!}
        <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Nome: </span>
        {!! Form::text('name', $pessoas->nomePessoa, ['class'=>'form-control', 'required', 'placeholder' =>'Insira o nome completo...']) !!}
        </div>
                    <div class="mb-3">
                        <div class="input-group">
                        <span class="input-group-text" id="basic-addon1">CPF: </span>
        {!! Form::text('cpf', $pessoas->CPFpessoa, ['class'=>'form-control', 'required', 'placeholder' =>'Insira CPF completo...']) !!}
            </div>
